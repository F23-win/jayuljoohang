...
class ParkingLidarTest(unittest.TestCase):
    ...
    def test_close_right_side_sparse_returns_trigger_first_car(self):
        ...
        self.assertTrue(observation.first_car_seen)
        self.assertTrue(observation.first_car_confirmed)
        self.assertTrue(observation.first_car_turn_reached)
