...
class ParkingConfigTest(unittest.TestCase):
    def test_repository_parking_config_loads_nested_rois(self):
        ...
        self.assertEqual(config.yolo.car_min_bottom_ratio, 0.20)
        ...
        self.assertEqual(config.lidar.max_distance_mm, 3500.0)
        ...
        self.assertEqual(config.planner.prealign_first_car_bearing_min_deg, 100.0)
        self.assertEqual(config.planner.prealign_min_drive_s, 9.0)
        self.assertEqual(config.planner.prealign_confirm_frames, 1)
        self.assertEqual(config.planner.prealign_path_hold_frames, 3)
        self.assertEqual(config.planner.prealign_yolo_min_lines, 1)
        self.assertEqual(config.planner.prealign_yolo_hold_frames, 3)
        self.assertEqual(config.planner.entry_path_loss_grace_frames, 2)
