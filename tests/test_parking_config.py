...
class ParkingConfigTest(unittest.TestCase):
    def test_repository_parking_config_loads_nested_rois(self):
        ...
        self.assertEqual(config.planner.prealign_speed, 70)
        ...
        self.assertEqual(config.planner.reverse_entry_speed, -70)
        self.assertEqual(config.planner.reverse_center_speed, -70)
        self.assertEqual(config.planner.correction_forward_speed, 22)
        self.assertEqual(config.planner.correction_reverse_speed, -70)
