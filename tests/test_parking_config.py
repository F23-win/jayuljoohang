...
class ParkingConfigTest(unittest.TestCase):
    def test_repository_parking_config_loads_nested_rois(self):
        ...
        self.assertEqual(config.planner.search_speed, 42)
        ...
        self.assertEqual(config.planner.first_car_straight_s, 1.6)
        ...
        self.assertEqual(config.planner.prealign_entry_bearing_tolerance_deg, 18.0)
        self.assertEqual(config.planner.prealign_center_x_tolerance_mm, 280.0)
        self.assertEqual(config.planner.prealign_curve_slot_heading_tolerance_deg, 90.0)
        self.assertEqual(config.planner.prealign_curve_entry_bearing_tolerance_deg, 90.0)
        self.assertEqual(config.planner.prealign_curve_center_x_tolerance_mm, 2200.0)
        self.assertEqual(config.planner.prealign_target_distance_min_mm, 300.0)
        ...
        self.assertEqual(config.planner.reverse_entry_speed, -32)
        self.assertEqual(config.planner.reverse_center_speed, -22)
        self.assertEqual(config.planner.correction_forward_speed, 22)
        self.assertEqual(config.planner.correction_reverse_speed, -28)
