...
class ParkingConfigTest(unittest.TestCase):
    def test_repository_parking_config_loads_nested_rois(self):
        ...
        self.assertEqual(config.lidar.first_car_confirm_scans, 1)
        ...
        self.assertEqual(config.planner.first_car_approach_speed, 30)
        ...
        self.assertEqual(config.planner.prealign_speed, 45)
        ...
        self.assertEqual(config.planner.prealign_curve_slot_heading_tolerance_deg, 57.0)
