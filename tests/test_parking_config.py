...
class ParkingConfigTest(unittest.TestCase):
    def test_repository_parking_config_loads_nested_rois(self):
        ...
        self.assertEqual(config.planner.start_forward_s, 4.0)
        self.assertEqual(config.planner.search_speed, 100)
        self.assertEqual(config.planner.straight_steering_trim, -35)
        ...
        self.assertEqual(config.planner.first_car_straight_s, 0.8)
